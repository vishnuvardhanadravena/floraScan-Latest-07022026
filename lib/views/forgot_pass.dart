...
class _ForgotPasswordMobileViewState extends State<ForgotPasswordMobileView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      provider.setchangePassErrorMsg("");
    });
  }
  ...
  Future<void> _handleResetPassword(ForgotPasswordProvider provider) async {
    final responce = await provider.changePassword(
      oldPassword: passwordController.text,
      confrimpassword: confirmPasswordController.text,
      newPassword: newpasswordController.text,
    );
    if (responce) {
      AppToast.success("password changed succesfull");
      ...
      AppToast.error(provider.changePassErrorMsg);
    }
  }
