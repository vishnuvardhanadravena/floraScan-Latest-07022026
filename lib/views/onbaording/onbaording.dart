...
//       size: isActive ? size.width * 0.04 : size.width * 0.03,
//     );
//   }
// }
      ...
      children: [
        ...
        if (data.showScanner)
          Positioned(
            ...
            child: Center(
              child: SizedBox(
                width: isTablet ? size.width * 0.4 : size.width * 0.7,
                height: isTablet ? size.width * 0.4 : size.width * 0.9,
                child: const ScannerFrame(),
              ),
            ),
          ),
...
class _ScannerFrameState extends State<ScannerFrame>
  ...
  Widget build(BuildContext context) {
    ...
    final double frameWidth = isTablet ? size.width * 0.6 : size.width * 0.8;

    final double frameHeight = isTablet ? frameWidth : size.height * 0.3;

    final double cornerSize = frameWidth * 0.09;
          ...
          children: [
            ...
            AnimatedBuilder(
              ...
              builder: (context, child) {
                ...
                final double cornerInset = cornerSize;
                final double scanAreaHeight =
                    frameHeight - (cornerSize * 1.2) - lineHeight;
                final double topOffset = (cornerSize +
                        (_controller.value * scanAreaHeight))
                    .clamp(cornerSize, frameHeight - cornerSize - lineHeight);
                return Positioned(
                  top: topOffset,
                  left: cornerInset,
                  right: cornerInset,
